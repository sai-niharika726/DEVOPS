...
FRUITS = [
    {"id": 1,  "name": "Apple",      "emoji": "🍎", "price": 30,  "unit": "kg",  "stock": 50, "color": "#ff6b6b", "bg": "#fff5f5", "desc": "Crispy & sweet!"},
    {"id": 2,  "name": "Banana",     "emoji": "🍌", "price": 20,  "unit": "doz", "stock": 40, "color": "#ffd93d", "bg": "#fffdf0", "desc": "Peel good vibes!"},
    {"id": 3,  "name": "Mango",      "emoji": "🥭", "price": 80,  "unit": "kg",  "stock": 30, "color": "#ff9a3c", "bg": "#fff8f0", "desc": "King of fruits!"},
